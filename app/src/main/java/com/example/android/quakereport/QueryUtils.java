...
public final class QueryUtils {
    ...
    public boolean checkEarthQuake = false;
...
//
    ...
    public static ArrayList<Earthquake>  extractEarthquakes(String earthquakeJSON) {
        ...
        Log.e("QueryUtils", "extractEarthquake() just started running");
        ...
        try {
            ...
            JSONObject jsonData = new JSONObject(earthquakeJSON);
            JSONArray featureArray = jsonData.getJSONArray("features");

            for(int i = 0; i<featureArray.length(); i++ ){
                JSONObject objectInFeature = featureArray.getJSONObject(i);
                JSONObject properties = objectInFeature.getJSONObject("properties");
                Double mag = properties.getDouble("mag");
                String place = properties.getString("place");
                Long time = properties.getLong("time");
                String url = properties.getString("url");

               Earthquake dataFile = new Earthquake(mag, place, time, url);
                earthquakes.add(dataFile);
            }
...
//        }
        ...
        try {
            json = connectHttp(urlist);
        }

        catch (Exception e){
            Log.e("QueryUtils", "error fetching the data");
        }

        ArrayList<Earthquake> dataTopresent = extractEarthquakes(json);
    ...
    private static URL createURL(String Stringurl){
        ...
        try{
            ...
            Log.v("QueryUtitils", "Error creating url");
        }

        return url;
    }

    private static String connectHttp(URL url)throws Exception{
         String Jsonresponse = "";
        ...
        try{
            ...
            if (urlConnection.getResponseCode() == 200){
                ...
                Log.v("QueryUtils", "The response code is" + urlConnection.getResponseCode());
            }
        }

        catch (IOException e){
            Log.e("QueryUtils", "Problem making a connection");
        }
        ...
        Log.v("QueryUtils", "This method fetches the data");
